...
def checkWatchlist(context):
    ...
    if int(number) >= 30:
        bot.sendMessage(USER_ID, f"You should remove {int(number)-29} films from your watchlist to keep it below 30 Serkan.")
...
def sendLessonSchedule(context):
    ...
    schedule = "Here is tomorrow's lesson schedule Serkan.\n"
...
def morningMessage(context):
    messages = ["Good morning Serkan!", "Good morning Serkan, hope you got your sleep well.", "Good morning! 🌅", "Good morning Serkan, was it a good sleep?"]
...
def nightMessage(context):
    messages = ["Good night Serkan!", "Good night Serkan, hope you'll get your sleep well.", "Good night! 🌃"]
